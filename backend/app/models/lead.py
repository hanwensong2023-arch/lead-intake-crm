...
class Lead(Base):
    ...
    assigned_attorney_id: Mapped[str | None] = mapped_column(ForeignKey("users.id"), nullable=True, index=True)
    assigned_attorney_email: Mapped[str | None] = mapped_column(String(255), nullable=True)
